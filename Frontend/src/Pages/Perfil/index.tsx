  ...
  return (
    <div className="max-w-2xl mx-auto p-6 mt-10 bg-white shadow-xl rounded-2xl">
      ...
      <div className="space-y-2">
        ...
        <p>
          <span className="font-semibold">Documento:</span> {usuario.documento}
        </p>
        <p>
        ...
        <p>
          <span className="font-semibold">Tipo de usuário:</span> {usuario.tipo}
        </p>
      </div>
        ...
        <div className="mt-6">
          ...
          <ul className="list-disc ml-6 mt-1 text-gray-600">
            {usuario.cursosMatriculados.length > 0 ? (
              usuario.cursosMatriculados.map((curso, i) => (
                <li key={i}>{curso}</li>
              ))
            ) : (
